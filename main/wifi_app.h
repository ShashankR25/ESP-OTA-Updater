...
#define WIFI_AP_MAX_CONNECTIONS 5				// AP max client
 ...
 * @note Expand the parameter list behind on your requirements e.g. how you've expanded the wifi_app_queue_message_t.
 */
