...
//Tag used for ESP serial console messgaes
 ...
 * @param arg data, aside from event data, that is passed to the hnndler when it is called
 * @param event_base the base id of the event to register the handler for
 * @param event_di the id for the event to register the handler for
...
static void wifi_app_default_wifi_init(void)
{
    ...
    // Default WiFi config - operation must be in the order!
